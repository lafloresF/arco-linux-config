...
complete -c curl -l doh-insecure -d 'Same as --insecure but used for DoH (DNS-over-HTTPS)'
...
complete -c curl -l proxy-cert -d 'Same as --cert but used in HTTPS proxy context'
...
complete -c curl -l proxy-insecure -d 'Same as --insecure but used in HTTPS proxy context'
...
complete -c curl -l proxy-tlsv1 -d 'Same as --tlsv1 but used in HTTPS proxy context'
